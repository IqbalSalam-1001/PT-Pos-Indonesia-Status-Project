        ...
        <div class="container-fluid">
          ...
          <div class="card">
                  ...
                  <tbody>
                    <?php foreach ($tbl as $row) : ?>
                      <tr>
                        ...
                        <td><?= $row['project_name']; ?>
                        <td><?= $row['tanggal_awal']; ?>
                        <td><?= $row['tanggal_akhir']; ?>
                        <td><?= $row['catatan']; ?>
                        <td class="row">
                          <form class="edit" action="<?= base_url('Admin/changeproject'); ?>" method="post">
                            <input type="hidden" name="id" value="<?= $row['id'] ?>" />
                            <button type="submit" class="btn btn-success"><i class="fas fa-pencil-alt"></i></button>
                          </form>
                          <form class="delete" action="<?= base_url('Admin/deleteproject'); ?>" method="post">
                            <input type="hidden" name="id" value="<?= $row['id'] ?>" />
            ...
            <div class="card-footer clearfix">
              <a href="<?= base_url('Admin/newproject'); ?>" class="btn btn-sm btn-info float-left">Create New</a>
