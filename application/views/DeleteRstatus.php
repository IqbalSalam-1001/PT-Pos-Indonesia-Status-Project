               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu1-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Admin/ph'); ?>" class="nav-link active">
                                        <i class="fas fa-folder-open"></i>
                                        <p>RStatus</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Delete Rstatus</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Home</a></li>
                                <li class="breadcrumb-item">Delete Rstatus</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="">
                            <div class="col-md-10">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?= base_url('admin/deletedir2'); ?>">
                                            ...
                                            <div class="col-12">
                                                <a href="<?= base_url('Admin/ph'); ?>" class="btn btn-secondary">Cancel</a>
