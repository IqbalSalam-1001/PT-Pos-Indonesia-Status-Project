    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Create New Rdirektorat</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">Home</a></li>
                <li class="breadcrumb-item">Create New Rdirektorat</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="">
              <div class="col-md-10">
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <form method="post" action="<?= base_url('admin/newrdirdb'); ?>">
                      <div class="form-group">
                        <label for="inputStatus">Deskripsi</label>
                        <input id="inputStatus" class="form-control" name="deskripsi" value="">
                        </input>
                      </div>
