        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Data Project</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Home</a></li>
                                <li class="breadcrumb-item">Edit Data Project</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="">
                            <div class="col-md-10">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?= base_url('admin/updateproject'); ?>">
                                            <input type="hidden" name="id" value="<?= $edt['id'] ?>" />
                                            <div class="form-group">
                                                <label for="inputStatus">Deskripsi</label>
                                                <select required id="inputStatus" class="form-control" name="direktorat">
                                                    <option value="">Pilih deskripsi</option>
                                                    <?php foreach ($direktorat as $dir) : ?>
                                                        <option <?= ($dir->id == $edt['direktorat']) ? 'selected' : '' ?> value="<?= $dir->id ?>"><?= $dir->deskripsi ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required id="inputStatus" class="form-control" name="bagian" value="<?= $edt['bagian'] ?>">
                                                </input>
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Pic Name</label>
                                                <input required id="inputStatus" class="form-control" name="pic_name" value="<?= $edt['pic_name'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">No Surat</label>
                                                <input required id="inputStatus" class="form-control" name="no_surat" value="<?= $edt['no_surat'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Tanggal</label>
                                                <input type="date" required id="inputStatus" class="form-control" name="tanggal" value="<?= $edt['tanggal'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Project Name</label>
                                                <input required id="inputStatus" class="form-control" name="project_name" value="<?= $edt['project_name'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Tanggal Awal</label>
                                                <input type="date" required id="inputStatus" class="form-control" name="tanggal_awal" value="<?= $edt['tanggal_awal'] ?>">

                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Tanggal Akhir</label>
                                                <input type="date" required id="inputStatus" class="form-control" name="tanggal_akhir" value="<?= $edt['tanggal_akhir'] ?>">

                                            </div>
                                            <div class="form-group">
                                                <label for="inputStatus">Catatan</label>
                                                <input required id="inputStatus" class="form-control" name="catatan" value="<?= $edt['catatan'] ?>">

                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Rproject</label>
                                                <select required id="inputStatus" class="form-control" name="rproject">
                                                    <option value="">Pilih rproject</option>
                                                    <?php foreach ($rproject as $dir) : ?>
                                                        <option <?= ($dir->id == $edt['rproject']) ? 'selected' : '' ?> value="<?= $dir->id ?>"><?= $dir->deskripsi ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
