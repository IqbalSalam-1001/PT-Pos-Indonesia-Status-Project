        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Delete Pengguna</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Home</a></li>
                                <li class="breadcrumb-item">Delete Pengguna</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="">
                            <div class="col-md-10">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?= base_url('admin/deletedir3'); ?>">
                                            <div class="form-group">
                                                <label for="inputStatus">ID Pengguna</label>
                                                <input disabled id="inputStatus" class="form-control" name="idpengguna" value="<?php echo $edt1['idpengguna']; ?>">
                                                <input type="hidden" name="idpengguna" value="<?= $edt1['idpengguna'] ?>"></input>
                                                </input>
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Nama</label>
                                                <input disabled id="inputStatus" class="form-control" name="nama" value="<?php echo $edt1['nama']; ?>">
                                                <input type="hidden" name="idpengguna" value="<?= $edt1['idpengguna'] ?>"></input>
                                                </input>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input disabled id="inputStatus" class="form-control" name="password" value="<?php echo $edt1['password']; ?>">
                                                <input type="hidden" name="idpengguna" value="<?= $edt1['idpengguna'] ?>"></input>
                                                </input>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input disabled id="inputStatus" class="form-control" name="status" value="<?php echo $edt1['status']; ?>">
                                                <input type="hidden" name="idpengguna" value="<?= $edt1['idpengguna'] ?>"></input>
                                                </input>
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Kode Lokasi</label>
                                                <input disabled id="inputStatus" class="form-control" name="nama" value="<?php echo $edt1['kodelokasi']; ?>">
                                                <input type="hidden" name="idpengguna" value="<?= $edt1['idpengguna'] ?>"></input>
                                                </input>
                                            </div>

                                            <div class="col-12">
                                                <a href="<?= base_url('Admin/index'); ?>" class="btn btn-secondary">Cancel</a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content bg-danger">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Apakah yakin ingin menghapus pengguna <b><i><?php echo $edt1['nama']; ?></i></b></p>
                                                        </div>
