    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Rproject</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">Home</a></li>
                <li class="breadcrumb-item">Rproject</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          ...
          <div class="card">
                  ...
                  <tbody>
                    <?php foreach ($tbl as $row) : ?>
                      <tr>
                        ...
                        <?php endif; ?>
                        <td class="row">
                          <form class="edit" action="<?= base_url('Admin/eprp'); ?>" method="post">
                            <input type="hidden" name="id" value="<?= $row->id ?>"></input:>
                            <button type="submit" class=" btn btn-success"><i class="fas fa-pencil-alt"></i></button>
                          </form>
                          <div class="col-md-1"></div>
                          <form class="edit" action="<?= base_url('Admin/delete1'); ?>" method="post">
                            <input type="hidden" name="id" value="<?= $row->id ?>"></input:>
            ...
            <div class="card-footer clearfix">
              <a href="<?= base_url('Admin/newrpro'); ?>" class="btn btn-sm btn-info float-left">Create New</a>
            </div>
            <!-- /.card-footer -->
          </div>
          <!-- /.card -->
