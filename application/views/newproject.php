        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Create New Data Project</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Home</a></li>
                                <li class="breadcrumb-item">Create New Data Project</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="">
                            <div class="col-md-10">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?= base_url('admin/createproject'); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required id="inputStatus" class="form-control" name="bagian" value="">
                                                </input>
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Pic Name</label>
                                                <input required id="inputStatus" class="form-control" name="pic_name" value="">
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">No Surat</label>
                                                <input required id="inputStatus" class="form-control" name="no_surat" value="">
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Tanggal</label>
                                                <input type="date" required id="inputStatus" class="form-control" name="tanggal" value="">
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Project Name</label>
                                                <input required id="inputStatus" class="form-control" name="project_name" value="">
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Tanggal Awal</label>
                                                <input type="date" required id="inputStatus" class="form-control" name="tanggal_awal" value="">

                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Tanggal Akhir</label>
                                                <input type="date" required id="inputStatus" class="form-control" name="tanggal_akhir" value="">

                                            </div>
                                            <div class="form-group">
                                                <label for="inputStatus">Catatan</label>
                                                <input required id="inputStatus" class="form-control" name="catatan" value="">
