          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu1" data-accordion="true">
            ...
            <li class="nav-item menu1-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="<?= base_url('Admin/prs'); ?>" class="nav-link active">
                    <i class="fas fa-folder-open"></i>
                    <p>RProject</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Edit Rproject</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">Home</a></li>
                <li class="breadcrumb-item">Edit Rproject</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="">
              <div class="col-md-10">
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <form method="post" action="<?= base_url('admin/updaterpro'); ?>">
                      <div class="form-group">
                        <label for="inputStatus">Deskripsi</label>
                        <input id="inputStatus" class="form-control" name="deskripsi" value="<?php echo $edt['deskripsi']; ?>">
                        </input>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <?php endif; ?>
                        <input type="hidden" name="id" value="<?= $edt['id'] ?>"></input>


                      </div>
                      <div class="col-12">
                        <a href="<?= base_url('Admin/prs'); ?>" class="btn btn-secondary">Cancel</a>
