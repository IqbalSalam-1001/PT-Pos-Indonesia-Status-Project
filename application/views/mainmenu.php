        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              <div class="table-responsive">
                <table class="table m-0" id="table-data">
                  ...
                  <tbody>
                    <?php foreach ($tbl as $table) : ?>
                      <tr>
                        <td><?= $table->idtable; ?>
                        <td><?= $table->idpengguna; ?>
                        <td><?= $table->nama; ?>
                        <td><span class="badge badge-warning"><?= $table->email; ?></span></td>
                        <td><?= $table->status; ?>
                        <td><?= $table->kodelokasi; ?>
                        <td class="row">
                          <form class="edit" action="<?= base_url('Admin/epp'); ?>" method="post">
                            <input type="hidden" name="idpengguna" value="<?= $table->idpengguna ?>"></input:>
                            <button type="submit" class="btn btn-success"><i class="fas fa-pencil-alt"></i></button>
                          </form>
                          <div class="col-md-1"></div>
                          <form class="edit" action="<?= base_url('Admin/delete3'); ?>" method="post">
                            <input type="hidden" name="idpengguna" value="<?= $table->idpengguna ?>"></input:>
            ...
            <div class="card-footer clearfix">
              <a href="<?= base_url('Auth/daftar'); ?>" class="btn btn-sm btn-info float-left">Create New</a>
