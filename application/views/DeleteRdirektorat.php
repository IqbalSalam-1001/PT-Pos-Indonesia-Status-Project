          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu1" data-accordion="true">
            ...
            <li class="nav-item menu1-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= base_url('Admin/prd'); ?>" class="nav-link active">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Delete Rdirektorat</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">Home</a></li>
                <li class="breadcrumb-item">Delete Rdirektorat</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="">
              <div class="col-md-10">
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <form method="post" action="<?= base_url('admin/deletedir'); ?>">
                      ...
                      <div class="col-12">
                        <a href="<?= base_url('Admin/prd'); ?>" class="btn btn-secondary">Cancel</a>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content bg-danger">
                            ...
                            <div class="modal-body">
                              <p>Apakah yakin ingin menghapus <?php echo $edt1['deskripsi']; ?></p>
                            </div>
