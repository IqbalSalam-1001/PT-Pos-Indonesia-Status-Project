        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Delete History Project</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Home</a></li>
                                <li class="breadcrumb-item">Delete HProject</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="">
                            <div class="col-md-10">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?= base_url('admin/deletedir5'); ?>">
                                            <input type="hidden" name="id" value="<?php echo $edt1['id']; ?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input disabled id="inputStatus" class="form-control" name="deskripsi" value="<?php echo $edt1['deskripsi']; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input disabled id="inputStatus" class="form-control" name="progress" value="<?php echo $edt1['progress']; ?>">
                                                <input type="hidden" name="id" value="<?= $edt1['id'] ?>"></input>
                                            </div>

                                            <div class="col-12">
                                                <a href="<?= base_url('Admin/ppppp'); ?>" class="btn btn-secondary">Cancel</a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content bg-danger">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Apakah yakin ingin menghapus history <?php echo $edt1['project_name']; ?></p>
                                                        </div>
