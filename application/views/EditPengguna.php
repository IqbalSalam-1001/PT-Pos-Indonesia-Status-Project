                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?= base_url('admin/updatepengguna'); ?>">
                                            <input type="hidden" name="idtable" value="<?php echo $edt['idtable']; ?>" />

                                            <div class="form-group">
                                                <label for="inputStatus">ID Pengguna</label>
                                                <input id="inputStatus" class="form-control" name="idpengguna" value="<?php echo $edt['idpengguna']; ?>">
                                                </input>
                                            </div>

                                            <div class="form-group">
                                                <label for="inputStatus">Nama</label>
                                                <input id="inputStatus" class="form-control" name="nama" value="<?php echo $edt['nama']; ?>">
                                                </input>
                                            </div>

                                            <!-- <div class="form-group">
                                                <label for="inputStatus">password</label>
                                                <input id="inputStatus" class="form-control" name="password" value="<?php echo $edt['password']; ?>">
                                                </input>
                                            </div> -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php if ($edt['status'] == 1) : ?>
                                                    <select id="inputStatus" class="form-control custom-select" name="status">
                                                        <option value="1" selected="selected"><?php echo $edt['status']; ?></option>
                                                        <option value="0"> 0 </option>
                                                    </select>
                                                <?php endif; ?>
                                                <?php if ($edt['status'] == 0) : ?>
                                                    <select id="inputStatus" class="form-control custom-select" name="status">
                                                        <option value="0" selected="selected"><?php echo $edt['status']; ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputStatus" class="form-control" name="kodelokasi" value="<?php echo $edt['kodelokasi']; ?>">
                                                </input>
                                            </div>
